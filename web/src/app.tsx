...
import {
	NaverMap,
	NavermapsProvider as NaverMapProvider,
	Container as NaverMapWrapper,
...
const App = () => {
	...
	return (
		<NaverMapProvider ncpClientId="kfo7c483xh">
				...
				>
					...
					>
						<CollapseSection title="Counterspell: Seoul">
							...
							<InformativeBox>
								...
								파고든다는 의미의 ‘해킹’(hacking)과 마라톤(marathon)의 합성어로,
								즉석에서 팀을 구성하여 정해진 시간 안에 무언가를 만드는 대회입니다.
							</InformativeBox>
						</CollapseSection>
					...
					>
						<CollapseSection title="위치">
							<NaverMapWrapper className="aspect-[5/3] mb-2.5">
								<NaverMap></NaverMap>
							</NaverMapWrapper>
